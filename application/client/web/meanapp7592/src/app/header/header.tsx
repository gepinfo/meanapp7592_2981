...
<a id="i9imej" className="gpd-text" href='/ticketupdate'>ticketupdate</a>
...
{check?(<div id="icrvgp" className="cell gpd-clm"  >
                                                        <div id="i6vd27" className="gdp-row gpd-grid"  >
                                                            ...
                                                            <div id="iytw4t" className="cell gpd-clm" >
                                                                <a id="i9imej" className="gpd-text" href="#types" data-toggle="collapse" data-parent="#MainMenu">types <i className="fa fa-caret-down"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>):<></>}
                                                    {check?( <div className="collapse" id="types">
                                                        <div id="icrvgp" className="cell gpd-clm">
                                                            <div id="i6vd27" className="gdp-row gpd-grid">
                                                                <div id="iytw4t" className="cell gpd-clm">
<a id="i9imej" className="gpd-text" href='/createtypes'>createtypes</a>
...
<a id="i9imej" className="gpd-text" href='/updateseverirty'>updateseverirty</a>
